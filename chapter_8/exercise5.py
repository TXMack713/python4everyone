# Python for Everybody, Chapter 8 - Lists, Exercise 5

# Minimalist Email Client.
#
# MBOX (mail box) is a popular file format to store and share a
# collection of emails. This was used by early email servers and
# desktop apps. Without getting into too many details, MBOX is a
# text file, which stores emails consecutively. Emails are separated
# by a special line which starts with From (notice the space).
# Importantly, lines starting with From: (notice the colon)
# describes the email itself and does not act as a separator.
# Imagine you wrote a minimalist email app, that lists the email of
# the senders in the user’s Inbox and counts the number of emails.
#
